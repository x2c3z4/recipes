//----------------------------------------------------------------
//      newinfo.cpp     Creates the skeleton for a '/proc' module
//
//      usage:  $ newinfo <modname>
//
...
//
//	programmer: NICHOLAS KEY
//	revised on: 16 DEC 2007 -- to show the kernel's version
//----------------------------------------------------------------
...
int main( int argc, char *argv[] )
{
        ...
        fprintf( fp, "//\t%s\n", srcname );
        fprintf( fp, "//\n" );
        fprintf( fp, "//\tNOTE: Written and tested with Linux kernel version" );	fprintf( fp, " %s \n", u.release );
        fprintf( fp, "//\n" );
        ...
        fprintf( fp, "\t// for create_proc_info_entry() \n" );
        fprintf( fp, "\n" );
        fprintf( fp, "char modname[] = \"%s\";\n", modname );

        fprintf( fp, "\nint my_get_info( char *buf, " );
